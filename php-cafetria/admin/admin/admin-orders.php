 ...
 *   - Auth guard
 *   - Query all orders (with optional status filter from GET)
 *   - Render the orders table rows
 *   - Pass order stats as JS variables for the client-side Claude AI call
 */
session_start();
...
// ── Stats for AI context (always unfiltered) ──────────────────────────────
$stats = $pdo->query("
    SELECT
        COUNT(*)                                          AS total,
    ...
    <div class="topbar">
        ...
        <div class="topbar-actions">
            <div class="search-wrap">
                ...
                <input class="search-input" type="text" id="orders-search"
                       placeholder="Search orders..." oninput="filterOrdersTable()">
            </div>

            <!-- Status filter — reloads page with ?status=... for server-side filtering -->
                ...
                <table id="orders-table">
                    ...
                    <?php else: ?>
                        ...
                        <tr data-status="<?= htmlspecialchars($o['status']) ?>"
                            ...
                            <td>
                                <span class="badge badge-<?= strtolower(htmlspecialchars($o['status'])) ?>">
            ...
            <div class="order-card"
                ...
                <div class="order-card-body">
                    ...
                    <div class="order-meta">
                        ...
                        Room <?= htmlspecialchars($o['room']) ?> · Ext. <?= htmlspecialchars($o['ext']) ?>
                    </div>
                    <div class="order-meta">
